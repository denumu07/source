...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'Whitty': //Week Whitty
				var bg:BGSprite = new BGSprite('Whitty/BG', -600, -200, 0.9, 0.9); 
				add(bg);

			case 'Destroyed': //Week Whitty (I dont really Want to make this a Animated Backgorund Lmao)
				var bg:BGSprite = new BGSprite('Whitty/WhittyBallistic', -600, -200, 0.9, 0.9); 
				add(bg);
		}
		...
		if (isStoryMode && !seenCutscene)
		{
			switch (daSong)
			{
				...
				case 'lo-fight': // Hi
                    startVideo('WhittyCutsene');

				case 'ballistic': // Hi	
					startVideo('WhittyBallisticCutsene');
